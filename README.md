...
cmake --build .
```
It is to be noted that a difference in CPU architecture or recent MAC OS may impact the building process. It may generate errors as shown below ![alt text](https://user-images.githubusercontent.com/85082930/172899138-4d8c3517-6aa8-4962-9743-6eaabe861f45.png)
