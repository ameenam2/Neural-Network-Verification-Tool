...
## Marabou 
Marabou, the SMT verification verification, operates by answring queries about a network's properties by translating the queries into constraint satification problems. 
